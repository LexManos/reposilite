...
project {
    ...
    params {
        ...
        text("docker_gradle_version", "7.6.1", label = "Gradle version", description = "The version of Gradle to use during execution of Gradle tasks.", display = ParameterDisplay.HIDDEN, allowEmpty = false)
